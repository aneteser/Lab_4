...
<html>
        <div id="pagecontainer">
                <div id="image">
			<img id="picture" src="about_us/img1.jpg" alt="Bookstore">
		</div>

		<h2>Our team</h2>
			<p>Once Upon a Book is full of smart, driven people who care a lot more about getting it done, and the relationships we build, than about proving how clever we are. Bain's people truly become a valuable extension of our clients' teams. As a result, our people are a primary reason our clients would recommend Bain to others.
			...
			It feels different to work with us.</p>
